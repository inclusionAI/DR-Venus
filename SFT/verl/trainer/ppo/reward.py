...
def compute_reward(data: DataProto, reward_fn: AbstractRewardManager, val_type) -> tuple[torch.Tensor, dict[str, Any]]:
    """
    ...
    """
    try:
        reward_result = reward_fn(data, return_dict=True, val_type=val_type)
